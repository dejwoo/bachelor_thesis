...
\begin{document}
\newglossaryentry{obd}{name=OBD-II, description={On-Board Diagnostics port}}
...
\newglossaryentry{i2c}{name=I${}^2$C, description={Single-board computer}}
...
\newglossaryentry{ecu}{name=ECU, description={Electronic Control Unit}, plural=ECUs }
\newglossaryentry{can}{name=CAN, description={Controller Area Network}}
\newglossaryentry{epa}{name=EPA, description={Environmental Protection Agency}}
\newglossaryentry{sae}{name=SAE, description={Society of Automotive Engineers}}
\newglossaryentry{oem}{name=OEM, description={Original equipment manufacturer}}
\newglossaryentry{pids}{name=PIDs, description={Parameter IDs}}
\newglossaryentry{v8}{name=V8, description={V8 JavaScript Engine}}
...
\chapter*{Attachments}   %hviezdicka ze necislovana kapitola  a nie je v obsahu
