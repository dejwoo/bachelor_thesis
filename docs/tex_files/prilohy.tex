\section*{Automatic Hardware Specification} % (fold)
\label{sec:automatic_hardware_specification}

% section automatic_hardware_specification (end)
\begin{itemize}
...
\end{itemize}
\section*{VI Monitor abilities} % (fold)
...
\end{itemize}
\section*{Bluetooth / WiFi Combination USB Technical Details} % (fold)
...
\end{itemize}
% section bluetooth_wifi_combination_usb_technical_details (end)
% section vi_monitor_abilities (end)
\section*{npm packages} % (fold)
